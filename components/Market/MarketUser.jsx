                ...
                <div className="container marketplace">
                    <div className="image-boxes">
                        ...
                        <div className="arrows">
                            <a href="https://market.aestheticrecord.com/" target="_blank" className="btn-arrow btn-left"><i className="icon-arrow-l"></i></a>
                            <a href="https://market.aestheticrecord.com/" target="_blank" className="btn-arrow btn-right"><i className="icon-arrow-r"></i></a>
                        </div>
                    </div>
                </div>
            </div>
